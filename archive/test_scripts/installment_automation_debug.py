...
def process_installment_debug(data_list):
    ...
    try:
        ...
        # 초기 상태 캡처
        capture_screen("debug_01_initial.png")
        time.sleep(0.5)
        ...
        time.sleep(0.5)
        capture_screen("debug_02_home.png")
        ...
        time.sleep(0.5)
        capture_screen("debug_03_first_employee.png")
        print("✓ 첫 번째 사원 선택 완료")
        ...
        for i in range(3):
            ...
            time.sleep(0.5)
            capture_screen(f"debug_04_tab_{i+1}.png")

        time.sleep(0.5)
        capture_screen("debug_05_after_all_tabs.png")
        ...
        time.sleep(1.0)
        capture_screen("debug_06_income_tax.png")
        print("  ✓ 소득세 입력 완료")
        ...
        time.sleep(0.5)
        capture_screen("debug_07_tab_to_local.png")
        ...
        time.sleep(1.0)
        capture_screen("debug_08_local_tax.png")
        print("  ✓ 지방소득세 입력 완료")
        ...
        time.sleep(1.0)
        capture_screen("debug_09_after_enter.png")
        print("  ✓ Enter 완료")

        # 최종 상태
        time.sleep(1.0)
        capture_screen("debug_10_final.png")

        print("\n" + "="*70)
        print("[완료] 스크린샷 10개 생성됨")
        print("  debug_01_initial.png ~ debug_10_final.png")
        print("="*70)
