...
def process_installment_debug(data_list):
    """디버그 모드 - set_focus와 send_keys 사용"""
    print("\n" + "="*70)
    print("분납적용 자동화 디버그 모드 v5 (set_focus + send_keys)")
    print("="*70)
    ...
    try:
        ...
        # 초기 상태 캡처
        capture_screen("debug5_01_initial.png")
        time.sleep(0.5)
        ...
        send_keys("{DOWN}")
        time.sleep(0.5)
        capture_screen("debug5_02_first_employee.png")
        print("✓ 첫 번째 사원 선택 완료")
        ...
        for i in range(3):
            ...
            send_keys("{TAB}")
            time.sleep(0.5)
            capture_screen(f"debug5_03_tab_{i+1}.png")

        time.sleep(0.5)
        capture_screen("debug5_04_after_all_tabs.png")
        ...
        time.sleep(1.0)
        capture_screen("debug5_05_income_tax.png")
        print("  ✓ 소득세 입력 완료")
        ...
        send_keys("{TAB}")
        time.sleep(0.5)
        capture_screen("debug5_06_tab_to_local.png")
        ...
        time.sleep(1.0)
        capture_screen("debug5_07_local_tax.png")
        print("  ✓ 지방소득세 입력 완료")
        ...
        send_keys("{ENTER}")
        time.sleep(1.0)
        capture_screen("debug5_08_after_enter.png")
        print("  ✓ Enter 완료")

        # 최종 상태
        time.sleep(1.0)
        capture_screen("debug5_09_final.png")

        print("\n" + "="*70)
        print("[완료] 스크린샷 9개 생성됨")
        print("  debug5_01_initial.png ~ debug5_09_final.png")
        print("="*70)
